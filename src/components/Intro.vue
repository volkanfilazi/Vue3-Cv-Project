      ...
      <div
        ...
        <div class="flex gap-5 p-2 transition-all duration-500">
          ...
          <a class="w-16 h-16 flex group cursor-pointer justify-center items-center transition-all duration-500 border-[2px] border-gray-500 rounded-full hover:border-yellow-400"
            ...
            <Icon class="text-gray-500 group-hover:text-yellow-400 transition-all duration-500" icon="ic:outline-facebook"
              width="36" height="36" />
          </a>
          <a class="w-16 h-16 flex group cursor-pointer justify-center items-center transition-all duration-500 border-[2px] border-gray-500 rounded-full hover:border-yellow-400"
            href="https://github.com/volkanfilazi">
            <Icon class="text-gray-500 group-hover:text-yellow-400 transition-all duration-500" icon="ph:github-logo-fill"
              width="36" height="36" />
          </a>
          <a class="w-16 h-16 flex group cursor-pointer justify-center items-center transition-all duration-500 border-[2px] border-gray-500 rounded-full hover:border-yellow-400"
