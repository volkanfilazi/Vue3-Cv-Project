...
<template>
  <div class="h-4/4 w-full">
    ...
    <div class="bg-black hidden md:grid grid-cols-5 items-center justify-center w-full h-1/4">
      ...
      <button @click="specializationTrigger()" class="bg-orange-800 p-2 h-full text-white">Specialization</button>
    ...
    <div class="flex flex-col md:flex-row w-full h-3/4">
      ...
      <div class="md:translate-x-full md:opacity-0 md:fixed transition-all duration-300 w-full h-full bg-red-800 md:bg-red-800"
        :class="[{ 'md:!translate-x-0': intro === true }, { 'md:!opacity-100': intro === true }]">
        <Intro></Intro>
      </div>

      <div class="md:translate-x-full md:opacity-0 md:fixed transition-all duration-500 w-full h-full bg-red-800 md:bg-purple-900"
        :class="[{ 'md:!translate-x-0': tools }, { 'md:!opacity-100': tools }]">
        <Tools></Tools>
      </div>

      <div class="md:translate-x-full md:opacity-0 md:fixed transition-all duration-500 w-full h-full bg-red-800 md:bg-green-950"
        :class="[{ 'md:!translate-x-0': languages }, { 'md:!opacity-100': languages }]">
        <Languages></Languages>
      </div>
      ...
      <div class="md:translate-x-full md:opacity-0 md:fixed transition-all duration-500 w-full h-full bg-red-800 md:bg-orange-800"
        :class="[{ 'md:!translate-x-0': specialization }, { 'md:!opacity-100': specialization }]">
        <Specialization></Specialization>
      </div>

      <div class="md:translate-x-full md:opacity-0 md:fixed transition-all duration-500 w-full h-full bg-red-800 md:bg-gray-900"
        :class="[{ 'md:!translate-x-0': resume }, { 'md:!opacity-100': resume }]">
