    ...
    <div class="hidden pb-2 pt-2 sm:hidden md:flex md:justify-between md:w-full md:items-center relative">
      ...
      <ul class="flex items-center gap-3" :class="[
        ...
        <a class="scroll-smooth cursor-pointer border-[1px] border-transparent hover:border-white hover:transition-all hover:duration-300 p-1"
          ...
          <div class="cursor-pointer border-[1px] border-transparent hover:border-white p-1" @click="themeToogle = !themeToogle">
            <li>Theme</li>
          </div>
      </ul>
      ...
      <div v-if="themeToogle" class="absolute right-0 translate-y-full mt-20">
        ...
        <div @click="changeColor('red')" class=" w-6 h-6 border-[2px] border-transparent  left-0 rounded-full bg-red-600 cursor-pointer" :class="{'border-white' : saveColor === 'red'}"></div>
        <div @click="changeColor('yellow')" class=" w-6 h-6 border-[2px] border-transparent  bg-yellow-400 rounded-full cursor-pointer" :class="{'border-white' : saveColor === 'yellow'}"></div>
      </div>
      </div>

    </div>
    <div class="flex flex-col md:hidden text-black">
